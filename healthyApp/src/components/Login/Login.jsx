    ...
    return ( 
        <Form  className='p-3' onSubmit={handleSubmit(submit)}>
            ...
            <Form.Group className='mt-3' controlId='formBasicEmail'>
                ...
                <Form.Control className='input' type='email' placeholder='Input Text' {...register('email')} required/>
            </Form.Group>
            ...
            <Form.Group className='mt-3' controlId='formBasicPassword'>
                ...
                <div className='d-flex align-items-center show'  onClick={() => setShow(!show)}>
                    <Form.Control className='input' type={show ? 'text' : 'password'} placeholder='* * * *' required {...register('password')}/>
                    { show ? 
...
<Form.Group className='mt-3' controlId='formBasicPassword'>
                <Form.Label className='form_label'> Contraseña </Form.Label>
                <div>
                    <Form.Control className='input' type={show ? 'text' : 'password'} placeholder='* * * *' {...register('password')}/>
                </div>
    </Form.Group>
...
<div className="form-floating mt-3">
          <Form.Control className='input' type={show ? 'text' : 'password'} placeholder='* * * *' {...register('password')} required />
          <label htmlFor="password" >Password</label>
          <div className="position-absolute pointer pwd-icon" onClick={() => setShow(!show)}>
            {show ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height={"1.5rem"}>
              <path d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
              <path fillRule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 010-1.113zM17.25 12a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" clipRule="evenodd" />
            </svg> : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height={"1.5rem"}>
              <path d="M3.53 2.47a.75.75 0 00-1.06 1.06l18 18a.75.75 0 101.06-1.06l-18-18zM22.676 12.553a11.249 11.249 0 01-2.631 4.31l-3.099-3.099a5.25 5.25 0 00-6.71-6.71L7.759 4.577a11.217 11.217 0 014.242-.827c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113z" />
